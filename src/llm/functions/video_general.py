...
VIDEO_GENERAL_QUERY_DEFINITIONS: Dict[str, QueryDef] = {
    ...
    "count_videos": {
        ...
        "sql": "SELECT COUNT(*) FROM videos WHERE ($1::timestamp IS NULL OR video_created_at >= $1::timestamp) AND ($2::timestamp IS NULL OR video_created_at < $2::timestamp);",
        "parameters": {
    ...
    "count_videos_views_gt": {
        ...
        "sql": "SELECT COUNT(*) FROM videos WHERE views_count > $1 AND ($2::timestamp IS NULL OR video_created_at >= $2::timestamp) AND ($3::timestamp IS NULL OR video_created_at < $3::timestamp);",
        "parameters": {
